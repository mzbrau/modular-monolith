...
public class IssueBusinessEntityTests
{
    ...
    public void Constructor_WithEmptyTitle_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() =>
            new IssueBusinessEntity(IssueId.New(), "", "Description", IssuePriority.Medium, null));
    }

    [Test]
    public void Update_WithValidData_UpdatesIssue()
    {
        var issue = new IssueBusinessEntity(IssueId.New(), "Old Title", "Old Description", IssuePriority.Low, null);
    ...
    {
        var issue = new IssueBusinessEntity(IssueId.New(), "Bug", "Description", IssuePriority.Medium, null);
